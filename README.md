...
- An [OpenAI API key](https://platform.openai.com) (for Whisper)

### 1 — Clone the repo

```bash
git clone https://github.com/your-username/ai-meeting-notes-generator.git
...
You should see:
```
🚀  AI Meeting Notes backend running on http://localhost:3001
...
> **Tip:** For the best local experience, serve the frontend with a simple static server:
> ```bash
> cd frontend
> npx serve .
> ```
